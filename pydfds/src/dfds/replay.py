...
def replay_stream(
    ...
    for channel_id in stream.channels.keys():
        ...
        for channel_prop_id in channel_props.keys():
            channel_info.append_child_value(
                channel_prop_id, channel_props[channel_prop_id]
            )
    ...
    for index_id in stream.index.keys():
        ...
        for stream_idx_prop_id in stream_idx_props.keys():
            stream_idx_info.append_child_value(
                stream_idx_prop_id, stream_idx_props[stream_idx_prop_id]
            )
    # add name and unit
